export function Features() {
  return (
    <section className="w-full pt-6 pb-6 bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-bold text-black text-sm md:text-base mb-0.5">
              FAST SHIPPING
            </h3>
            <p className="text-gray-600 text-xs">(US & WORLDWIDE)</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-xs">GUARANTEE</p>
          </div>
